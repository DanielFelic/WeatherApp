...
class MainActivity : AppCompatActivity() {
    ...
    val CITY: String = "paulínia,br"
    val API: String = "2492952a140b48bceac9fecf618678f6"
    ...
    inner class weatherTask(): AsyncTask<String, Void, String>(){
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val updateAtText = "Updated at: "+ SimpleDateFormat(
                    "dd/MM/yyyy hh:mm a", Locale.ENGLISH).format(Date(updateAt*1000))
